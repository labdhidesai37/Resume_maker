...
public class PersonalInfo implements Parcelable {
    ...
    public PersonalInfo() {
        this("John", "Doe", "24-March-1975", "Single", "Senior Web Developer specialiing in front end development.Experienced with all stages of the development cycle for dynamic web projects.Well-versed in numerous programing languages including HTML, PHP, OOP, JavaScript, CSS, MySQL. Strong background  in project managment and customer relations.", "Web Developer", "176 Great portland street, New York, USA", "16 Great portland street, New York, USA", "202-555-0166", "john.doe@gmail.com");
    }
