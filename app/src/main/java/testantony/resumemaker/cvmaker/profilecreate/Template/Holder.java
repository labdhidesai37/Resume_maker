...
import testantony.resumemaker.cvmaker.profilecreate.Utils.RoundedHorizontalProgressBar;
        ...
        if (tvName != null) {
            ...
            if (rateTv != null) {
                ...
                if (rattingLayout != null) {
                    ...
                    throw new NullPointerException("null cannot be cast to non-null type com.documentviewer.reader.scaner.pdfreader.toolsapp.view.RoundedHorizontalProgressBar");
                }
